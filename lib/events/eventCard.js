...
export function formatRosterCardLine(event) {
  ...
  if (regMode === "TEAM") return `Team · ${roster}`;
  return roster;
}

export function isRegistrationComingSoon(event) {
...
export function deriveEventCardStatus(event, ui) {
  ...
  if (eventStatus === "COMPLETED") {
    return { text: "EVENT COMPLETED", tone: "muted", showDot: false };
  }
  if (eventStatus === "CANCELLED") {
    return { text: "EVENT CANCELLED", tone: "err", showDot: false };
  }
  if (ui.code === "FULL") {
    return { text: "EVENT FULL", tone: "err", showDot: false };
  }
  if (ui.code === "COMING_SOON" || isRegistrationComingSoon(event)) {
    return { text: "COMING SOON", tone: "warn", showDot: false };
  }
  if (ui.code === "REGISTRATION_CLOSED") {
    return { text: "REGISTRATION CLOSED", tone: "muted", showDot: false };
  }
  if (ui.code === "CLOSED") {
    return { text: "EVENT CLOSED", tone: "muted", showDot: false };
  }
